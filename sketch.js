//const is like a variable 
//Engien is the object on which the physics conditions are applied 
//Matter is the physics library
//creating physical body and world for the object
...
//creating groups and single objects properties
...
function preload()
{
  ...
  //making them play according to the conditions given 
  blink.playing = true;
  eat.playing = true;
  sad.playing = true;
  sad.looping= false;
...
function setup() 
{
  ...
  rectMode(CENTER);
  //change the shape into a circle 
  ellipseMode(RADIUS);
  textSize(50)
...
function draw() 
{
  ...
  //updating all the changes made in engine 
  Engine.update(engine);
  ground.show();

  drawSprites();

  //collision of fruit with the bunny
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   //collision of stars with the fruit
...
// functionality for different buttons 
function drop()
{
  cut_sound.play();
  rope.break();
...
function airblow()
{
  //applying force with the help of baloon to make the game difficult
