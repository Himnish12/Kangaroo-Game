class Rope
  ...
  this.pointA = pointA;
  //composites is  like a group of the object
  ...
  World.add(engine.world, this.body);
    ...
    drawVertices(vertices) 
    {
      ...
      ///showing angles and different properties of the objects 
   ...
   {
     // giving constraint to each and every rope
     if(constraints!=null)
     {
  ...
  drawConstraint(constraint) {
    if(constraint!=null)
      {//creating features for the rope 
    ...
    strokeWeight(4);
    stroke(255);
    line(//different axis on the screen to be tracked 
      posA.x + offsetA.x,
      posA.y + offsetA.y,
      posB.x + offsetB.x,
      posB.y + offsetB.y
